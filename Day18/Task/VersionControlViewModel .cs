...
namespace Task
{
    public class VersionControlViewModel : INotifyPropertyChanged
    {
        ...
        public async System.Threading.Tasks.Task LoadDocumentsAsync()
        {
            Documents.Clear();
        ...
        public async System.Threading.Tasks.Task LoadVersionsForSelectedDocument()
        {
            Versions.Clear();
        ...
        public async System.Threading.Tasks.Task AddVersionAsync(int versionNumber, DateTime createdAt, string author)
        {
            if (SelectedDocument == null) return;
        ...
        public async System.Threading.Tasks.Task DeleteVersionAsync()
        {
